  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        $tzdefault = get_option('timezone_string');
        ?>
        <select id="timezone" name="timezone" class="zvc-hacking-select">
          <?php foreach ($tzlists as $k => $tzlist) { ?>
            <option value="<?php echo $k; ?>" <?php !empty($meeting_fields['timezone']) ? selected($k, $meeting_fields['timezone']) :
                                                selected($k, $tzdefault);
                                              ?>><?php echo $tzlist; ?></option>
          <?php } ?>
        </select>
    ...
    <tr>
      ...
      <td>
        <input type="number" name="duration" class="regular-text" 
            value="<?php echo isset($meeting_fields['duration']) ? $meeting_fields['duration'] : false; ?>">
    ...
    <tr>
      ...
      <td>
        <input type="text" name="password" class="regular-text" maxlength="10" data-maxlength="9"
            value="<?php echo isset($meeting_fields['password']) ? $meeting_fields['password'] : false; ?>">
